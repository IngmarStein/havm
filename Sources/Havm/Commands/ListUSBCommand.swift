...
struct ListUSBCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        abstract: "List USB devices persisted for passthrough by havm-connect."
    )
    ...
    func run() async throws {
        ...
        if devices.isEmpty {
            ...
            print("")
            print("Use the havm-connect app to discover and select USB devices")
        ...
        print("Persisted USB devices (from havm-connect):")
